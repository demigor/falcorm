...
var mssqlPassword = builder.AddParameter("mssql-password", "ChangeIt!", secret: true);
...
var postgresPassword = builder.AddParameter("postgres-password", "ChangeIt!", secret: true);
