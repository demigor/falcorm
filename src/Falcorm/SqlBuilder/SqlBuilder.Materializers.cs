...
public partial class SqlBuilder<T>
{
  ...
  public IEnumerable<T> Enum() => _materializer.Enum(BuildCommand());
  ...
  public SqlBuilder<T> Insert([InterpolatedStringHandlerArgument("")] ref SqlBuilderHandler<T> columns, [InterpolatedStringHandlerArgument("")] ref SqlBuilderHandler<T> values) => Insert_(columns.Text, values.Text);
  /// <summary>Reloads data for the specified columns using the given filter. For internal use.</summary>
  [EditorBrowsable(EditorBrowsableState.Never)]
  public SqlBuilder<T> Reload([InterpolatedStringHandlerArgument("")] ref SqlBuilderHandler<T> columns, [InterpolatedStringHandlerArgument("")] ref SqlBuilderHandler<T> filter) => Reload_(columns.Text, filter.Text);
  ...
  /// <summary>Adds a WHERE clause with the given predicate expression.</summary>
  public SqlBuilder<T> Join([InterpolatedStringHandlerArgument("")] ref SqlBuilderHandler<T> join) => Join_(join.Text);
